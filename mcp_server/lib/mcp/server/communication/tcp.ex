defmodule MCP.Server.Communication.TCP do
  @moduledoc """
  The TCP adapter.

  This adapter can be used to launch the MCP with a given port and can be connected to by multiple clients.

  This adapter is also used during test by `MCP.Server.Test`.
  """
