defmodule MCP.Server.Communication.Adapter do
  @moduledoc """
  Behaviour for implementing communication adapters for the `MCP.Server.Buffer` module to use.

  Existing implementations:

  * `MCP.Server.Communication.Stdio`
  * `MCP.Server.Communication.TCP`
  """
  @type state :: any()
